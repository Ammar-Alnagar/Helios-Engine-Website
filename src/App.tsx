    ...
    <>
      ...
      {!isLoading && (
        <div className="min-h-screen relative transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto w-full">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                  ...
                  agents with tool support, streaming chat capabilities, and
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  Get started with Helios Engine in minutes with our
          ...
          {/* CTA Section */}
          <ScrollSection className="py-20 bg-transparent relative">
            <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
                  ...
                  of AI with Helios Engine. Start your journey today with our
          ...
          <footer
            data-scroll-section
            className="bg-gray-900 dark:bg-black text-white py-12 relative min-h-screen flex items-center"
          >
